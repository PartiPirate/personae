...
if ($themeType == "dlp_themes") {
	...
	$eligiblesGroups = $groupBo->getMyGroups(array("the_id" => $_REQUEST["del_theme_id"], "state" => "eligible"));
	...
	$votingsGroups = $groupBo->getMyGroups(array("the_id" => $_REQUEST["del_theme_id"], "state" => "voting"));
