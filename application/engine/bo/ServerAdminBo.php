...
*/
	...
	function create(&$admin) {
		$query = "	INSERT INTO dlp_server_admins (sad_server_id, sad_member_id) VALUES (:sad_server_id, :sad_member_id)	";
	...
	function delete($admin) {
		$query = "	DELETE FROM dlp_server_admins WHERE sad_server_id = :sad_server_id AND sad_member_id := sad_member_id";
