...
<div class="container theme-showcase" role="main">
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading"><?php echo lang("about_what_s_personae_legend"); ?></div>
			<div class="panel-body"><?php echo lang("about_what_s_personae_content"); ?></div>
		</div>
	</div>
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<ul class="list-group">
				<li class="list-group-item"><a href="https://github.com/PartiPirate/personae"
						target="_blank">Github Repository</a><span class="badge"><a class="color-inherit"
						href="https://github.com/PartiPirate/personae" target="_blank"><span
